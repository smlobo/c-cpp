...
// Forward declaration
void HTree(SDL_Renderer *, int, int, int, int);
...
int main(int argc, char **argv) {
    ...
    std::cout << "H-tree depth: " << depth << std::endl;
    ...
    SDL_Window *window = SDL_CreateWindow("C++ H-Tree", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED,
